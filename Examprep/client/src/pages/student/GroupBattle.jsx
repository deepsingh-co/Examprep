...
const GroupBattle = () => {
  ...
  const renderMenu = () => (
    <div className="max-w-4xl mx-auto relative z-10">
      <div className="text-center mb-12">
        <div className="w-20 h-20 mx-auto bg-primary/20 rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-primary/30">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Create Room */}
        <div className="surface-card p-8 relative overflow-hidden group hover:border-primary/50 transition-colors duration-500">
        ...
        {/* Join Room */}
        <div className="surface-card p-8 relative overflow-hidden group hover:border-accent-cyan/50 transition-colors duration-500">
  ...
  const renderLobby = () => (
    <div className="max-w-md mx-auto text-center relative z-10 mt-10">
      <div className="surface-card p-10 relative overflow-hidden shadow-sm">
        ...
        <div className="bg-background/50 border border-gray-200 p-6 rounded-2xl mb-8 relative z-10">
          ...
          <div className="flex items-center justify-center gap-4">
            <span className="font-mono text-5xl font-black tracking-[0.2em] text-primary drop-shadow-sm">
              {room?.room_code}
            </span>
            <button
              onClick={() => {
        ...
        {!battleStarted && (
          <div className="mb-8 relative z-10">
            ...
            <p className="text-sm text-gray-500 mt-3 font-medium">Waiting for players to join...</p>
          </div>
        )}
        ...
        <button
          ...
          className="w-full bg-green-500/90 hover:bg-green-500 disabled:opacity-40 py-4 rounded-xl font-bold text-gray-900 text-lg transition-all flex items-center justify-center gap-3 shadow-sm hover:-translate-y-1 relative z-10"
        >
  ...
  const renderBattle = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-6 flex items-center justify-between surface-card px-6 py-4 rounded-xl">
          ...
          <div className="bg-background px-4 py-1.5 rounded-full border border-gray-200 text-sm font-bold text-gray-600">
            ...
            <div className="surface-card p-8 min-h-[400px] flex flex-col">
              ...
              {answers[currentIndex] !== undefined && (
                <button
                  ...
                  className="w-full mt-6 bg-primary/90 hover:bg-primary py-4 rounded-xl font-bold text-gray-900 text-lg transition-all shadow-sm hover:-translate-y-1"
                >
